        ...
        return [
            Actions\Action::make('previsualizar')
                ...
                ->action(function () {
                    ...
                    exec('node /root/dev/paroquiansrjericopb/scripts/build-content.js --preview-stdin --type homilias 2>&1 < /tmp/paroquia_preview_in.json', $out, $exit);
                    if ($exit !== 0) {
